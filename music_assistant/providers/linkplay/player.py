...
if TYPE_CHECKING:
    ...
    from .provider import LinkPlayPlayerprovider
...
class LinkPlayPlayer(Player):
    ...
    def __init__(
        self, provider: LinkPlayPlayerprovider, player_id: str, wiimplayer: pywiim.Player
    ) -> None:
        """Initialize the Player."""
        super().__init__(provider, player_id)

        # init some static variables
        self._attr_name = f"LinkPlay Player {player_id}"
    ...
    async def volume_set(self, volume_level: int) -> None:
        ...
        await self.wiimplayer.set_volume(volume_level / 100)
    ...
    async def volume_mute(self, muted: bool) -> None:
        ...
        await self.wiimplayer.set_mute(muted)
    ...
    async def play_media(self, media: PlayerMedia) -> None:
        ...
        await self.wiimplayer.play_url(media.uri)
    ...
    def on_state_changed(self) -> None:
        ...
        self._attr_volume_level = self.wiimplayer.volume_level * 100
        self._attr_volume_muted = self.wiimplayer.is_muted
        match self.wiimplayer.state:
            case "playing":
            ...
            case "buffering":
                self._attr_playback_state = PlaybackState.UNKNOWN
